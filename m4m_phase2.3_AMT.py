...
for user in data["M4M_Phase2_AMT"]: 
	...
	try:
		...
		data["M4M_Phase2_AMT"][user]["results"] = getRoundTime(user,"A") ## getRoundTime's function second argument is "A", 
...
with open('m4m_AMT.csv', 'w') as file:
    ...
    for row in data["M4M_Phase2_AMT"]:
    	try:
    		...
    		data["M4M_Phase2_AMT"][row]["results"]["community A clicks"],data["M4M_Phase2_AMT"][row]["results"]["community B clicks"],data["M4M_Phase2_AMT"][row]["results"]["community C clicks"],data["M4M_Phase2_AMT"][row]["results"]["community D clicks"],
    		data["M4M_Phase2_AMT"][row]["results"]["community E clicks"],data["M4M_Phase2_AMT"][row]["results"]["round A duration"],data["M4M_Phase2_AMT"][row]["results"]["round B duration"],data["M4M_Phase2_AMT"][row]["results"]["round C duration"],
    		data["M4M_Phase2_AMT"][row]["results"]["round D duration"],data["M4M_Phase2_AMT"][row]["results"]["round E duration"],
    		#round A
